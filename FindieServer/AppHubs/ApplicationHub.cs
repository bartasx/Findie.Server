...
namespace FindieServer.AppHubs
{
    public class ApplicationHub : Hub
    {
        ...
        public async Task SendCurrentLocation(double latitude, double longitude, string username)
        {
            await this.Clients.All.SendAsync("sendLocation", latitude, longitude, username);
        }
